...
class LogisticLoss(LossFunction):
    ...
    def lossGradient(self, X, Y, Yhat):
        ...
        ### TODO: YOUR CODE HERE
        grad = -Y / (1 + exp(Y * Yhat))
        return sum((grad.reshape(-1, 1) * X), axis=0)
...
class HingeLoss(LossFunction):
    ...
    def lossGradient(self, X, Y, Yhat):
        ...
        mask = (1 - Y * Yhat) > 0
        grad = -Y[mask]
        return sum((grad.reshape(-1, 1) * X[mask]), axis=0)
...
class LinearClassifier(BinaryClassifier):
    ...
    def train(self, X, Y):
        ...
        def func(w):
            ...
            self.weights = w
            Yhat = X @ self.weights    ### TODO: YOUR CODE HERE
        ...
        def grad(w):
            ...
            self.weights = w
            Yhat = X @ self.weights     ### TODO: YOUR CODE HERE
            grad_loss = lossFn.lossGradient(X, Y, Yhat)
            gr   = gr = grad_loss + lambd * w    ### TODO: YOUR CODE HERE
